...
public class LobbyTLMN : RoomInfo
{
    public int betting;
    ...
    public LobbyTLMN(int zoneId, int roomId, int gameId)
    {
        this.zoneId = zoneId;
        this.roomId = roomId;
        this.gameId = gameId;
    }
    public LobbyTLMN(int gameId)
    {
        this.gameId = gameId;
    }

    public LobbyTLMN(EsObject obj)
    {
    ...
    #region TLMN
    public const string DEFINE_USING_CHATCHONG_RULE = "usingChatChongRule";
    public const string DEFINE_GAME_TYPE_TLMN = "gameType";
    #endregion
    ...
    public class GameConfig
    {
        ...
        public GameTypeLTMN GAME_TYPE_TLMN; //1: Đếm lá, 2: Xếp hạng

        /// <summary>
        /// Cho TLMN
        /// </summary>
        public bool CHAT_CHUONG_RULE;
        ...
        public GameConfig(int GAME_TYPE_TLMN, bool CHAT_CHUONG_RULE, bool BASE_RULE, bool U_TRON_RULE, bool U_XUONG_RULE, bool XAO_KHAN_RULE, bool DEN_CHONG_RULE, bool CHOT_CHONG_RULE)
        {
            this.GAME_TYPE_TLMN = (GameTypeLTMN)GAME_TYPE_TLMN;

            this.CHAT_CHUONG_RULE = CHAT_CHUONG_RULE;
        ...
        public static string GetGameRule(bool U_TRON_RULE, bool U_XUONG_RULE, bool XAO_KHAN_RULE, bool DEN_CHONG_RULE, bool CHOT_CHONG_RULE)
        {
			...
			if(GameManager.GAME == EGame.Phom)
				...
				return string.IsNullOrEmpty(ruleGame.ToString()) ? "Chặt chồng" : ruleGame.ToString().Substring(0, ruleGame.ToString().Length-2);
        }
    }
}
