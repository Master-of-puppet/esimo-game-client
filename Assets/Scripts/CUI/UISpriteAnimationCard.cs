...
/// <summary>
/// Cái này CÔNG viết nhé. Mình cũng chỉ biết là viết lại từ UISpriteAnimation mục đích không cho MakePixelPerfect
/// Chi tiết hỏi CÔNG nhé.
/// </summary>
[ExecuteInEditMode]
[RequireComponent(typeof(UISprite))]
[AddComponentMenu("NGUI/UI/Sprite Animation")]
public class UISpriteAnimationCard : MonoBehaviour
{
	
	[SerializeField] public int mFPS = 30;
	[SerializeField] public string mPrefix = "";
